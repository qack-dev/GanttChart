...
'////////////////////////////////////////////////////////////////////////////////////////////////////
'// M_ChartEvents モジュール
'// Shapeオブジェクトによるクリックイベントを処理していましたが、
'// セルベースの表示への変更に伴い、このモジュールは不要になりました。
'// 代替処理は Sheet_GanttChart モジュールの Worksheet_SelectionChange イベントに実装されています。
'////////////////////////////////////////////////////////////////////////////////////////////////////
